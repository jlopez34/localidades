...
public class LocalidadeCSV {
    ...
    public LocalidadeCSV(){

    }

    public LocalidadeCSV(int idEstado, String siglaEstado, String regiaoNome, String nomeCidade, String nomeMesorregiao, String nomeFormatado) {
